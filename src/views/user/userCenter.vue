<template>
  <div class="main">
    <div class="center-view">
      <div class="avatar">
        <router-link to="/login" v-if="!$store.state.userimg">
          <img v-if="!$store.state.userimg" src="https://mall.s.maizuo.com/e915e2c990c30f8efa9e30bc75da41ee.jpg"
            class="avator-icon">
        </router-link>
        <img v-if="$store.state.userimg" :src="$store.state.userimg" class="avator-icon">
        <div class="nick-name" v-if="$store.state.username">{{$store.state.username}}</div>
      ...
      <ul class="my-order-tab">
        <li><img
            ...
            width="26px" height="26px" alt=""> <span class="mint-badge is-primary is-size-small"
      ...
      <!---->
      <div class="margin-set my-card"><img
          ...
          width="20px" height="20px" alt=""> <span class="label">卖座券</span> <img
      ...
      <div class="margin-set my-card"><img
          ...
          width="20px" height="20px" alt=""> <span class="label">组合红包</span> <img
          src="data:image/png;base64,"
          alt="" class="arrow"></div>
      <div class="margin-set my-balance"><img
          ...
          width="20px" height="20px" alt=""> <span class="label">余额</span> <span class="value"><span
            class="price-decimal price-fmt"><i>￥</i> <span class="interge" style="font-size: 15px;">10000</span> <span
              style="display: none;">.</span> <span class="decimal" style="font-size: 10px;"></span> <span
              style="display: none;">.</span> <span class="decimal" style="font-size: 10px; display: none;">00</span>
          </span></span> <img
          src="data:image/png;base64,"
          alt="" class="arrow"></div>
      <div @click="usesetting" class="margin-set system-set"><img
          ...
          width="20px" height="20px" alt=""> <span class="label">设置</span> <img
          src="data:image/png;base64,"
          alt="" class="arrow"></div>
    </div>
  </div>
  ...
  methods: {
    ...
    getinfo (value) {
      getuserinfo({ token: value }).then(res => {
        // console.log(res);
        if (res.status == 0) {
          Cookies.set('username', res.data.nickName, { expires: 7, path: '' })
          Cookies.set('userimg', res.data.headIcon, { expires: 7, path: '' })
          this.setusername(res.data.nickName)
          this.setuserimg(res.data.headIcon)
        }
